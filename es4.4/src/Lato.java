...
public class Lato extends Group{
	private Texture texture;
	private static final int N_COL = 12;
	private static final float DIST_COL = 0.15f;

	public Lato(Texture texture){
	...
	public TransformGroup addArchitrave(Appearance app){
		...
		transform.addChild(new Architrave((N_COL/16) + (DIST_COL*(N_COL-1)), app));
