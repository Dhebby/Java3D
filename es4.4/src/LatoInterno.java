...
public class LatoInterno extends Group{
	...
	public TransformGroup addArchitrave(Appearance app){
		...
		Box box = new Box(1.0f, 0.05f, 0.07f, Primitive.GENERATE_TEXTURE_COORDS | Primitive.GENERATE_NORMALS, app);
